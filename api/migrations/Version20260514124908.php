 ...
 */
final class Version20260514124908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE app_user ADD age_verified TINYINT DEFAULT 0 NOT NULL, ADD age_verified_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `app_user` DROP age_verified, DROP age_verified_at');
        $this->addSql('ALTER TABLE mus_match DROP FOREIGN KEY FK_33B4AF25E72BCFA4');
        $this->addSql('ALTER TABLE mus_match DROP FOREIGN KEY FK_33B4AF25F59E604A');
        $this->addSql('ALTER TABLE mus_match DROP FOREIGN KEY FK_33B4AF255DFCD4B8');
