...
// Revert Computed property
const targetComputed = `const bracketMatches = computed(() => {
  const cols = [];
...
const revertComputed = `const bracketMatches = computed(() => {
  const cols = [];
...
content = content.replace(targetComputed, revertComputed);

// Revert HTML
const targetHtml = `<div class="flex overflow-x-auto py-8 px-2 gap-8 bracket-container justify-content-center">
...
const revertHtml = `<div class="flex overflow-x-auto py-8 px-2 gap-8 bracket-container justify-content-center">
...
content = content.replace(targetHtml, revertHtml);
