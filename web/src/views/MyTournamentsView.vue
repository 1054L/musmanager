    ...
    <section class="tournaments-section mus-glass p-0 overflow-hidden">
      ...
      <Popover ref="enrollOp" class="mus-glass-dark p-0 border-white/10 shadow-2xl overflow-hidden">
        <div class="p-6 w-[320px]">
          <div class="text-[10px] uppercase font-black tracking-widest text-[#e9c349] mb-6">
              {{ t('team_form.title') }}
          </div>
          <TeamEnrollmentForm 
...
.status-indicator.active { color: var(--secondary); }
.status-indicator.active::before { background: var(--secondary); box-shadow: 0 0 10px var(--secondary); }
